                    ...
                    <div className="mb-3 pt-3 border-t border-gold-400/20">
                      ...
                      <div className="mb-3">
                        <h4 className="text-xs font-bold text-gold-400 mb-2 flex items-center gap-1">
                          ...
                          Available Courses (Click to view)
                        </h4>
                        <div className="flex flex-wrap gap-1">
                          {university.courses?.map((course, idx) => (
                            <Link
                              ...
                              className="px-2 py-1 bg-gold-400/10 border border-gold-400/30 rounded text-xs text-gray-300 hover:bg-gold-400/20 hover:border-gold-400/50 transition-all cursor-pointer"
                            >
                              {course}
                            </Link>
                          ))}
