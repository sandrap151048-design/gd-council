          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Link href="/login" className="px-8 py-4 bg-transparent text-gold-400 font-semibold rounded-lg border border-gold-400/30 hover:bg-gold-400/10 hover:border-gold-400 transition-all">
                  Contact Sales
                </Link>
              </div>
            </div>
